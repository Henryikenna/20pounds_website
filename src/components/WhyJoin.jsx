...
export default function WhyJoin() {
  ...
  return (
    ...
    <section className="section bg-[#101010] text-tpBlack">
      <div className="container-tight grid md:grid-cols-2 gap-14 h-3/4 items-center !px-8 py-16 md:!px-16 md:py-24 bg-cream">
        <div>
          <h2 className="font-variant-small-caps text-3xl tracking-wide font-bold">Why Join <span className="!font-dancingScript text-gold [font-variant-caps:normal]">Us</span></h2>
          ...
          <button className="btn mt-10 md:mt-20">Apply Now</button>
        </div>
