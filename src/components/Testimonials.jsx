  ...
  return (
    <section className="section">
      <div className="container-tight text-center">
        ...
        {/* SLIDER MOBILE VERSION - SWIPEABLE */}
        <div className="mt-11 bg-tpBlack block lg:hidden px-4">
          <div 
          ...
          >
            <div className="relative text-center bg-cream text-tpBlack rounded-3xl p-8 min-h-[500px] flex flex-col max-w-sm mx-auto touch-pan-y">
              <img src={QuoteIcon} alt="" className="h-[1.375rem] mb-4" />
            ...
            {/* Swipe Hint Text (optional) */}
            <p className="text-center text-tpGrey text-sm mt-4">
